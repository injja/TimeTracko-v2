<template>
    ...
    <v-main app>
        ...
        <v-btn @click="deleteWorkspace" text >Delete this project</v-btn>
      ...
      >
        ...
        <div class="text-center">
          ...
          <h1 class="text-h2 font-weight-bold">Your Projects</h1>
        ...
        <v-row>
          ...
          <v-col cols="6" v-for="info in projects" :key="info.id">
            <RouterLink style="text-decoration: none; color: inherit;" :to="'/workspace/'+workspaceId+'/project/'+info.id"> 
            <v-card
...
<script setup>
  ...
  const deleteWorkspace = async () => {
        ...
        auth: {
            ...
            'Host': new URL(url).host || 'localhost' 
        }
        })
        .then(response => {
            console.log("tak");
